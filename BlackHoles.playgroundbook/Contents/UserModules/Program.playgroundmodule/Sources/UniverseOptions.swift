...
public struct UniverseOptions {
    ...
    public init() {
        self.init(universeUpdateType: .together, universeRadius: 2000, imageResolution: 256, blackHoleDistance: 1000, cameraViewFieldAngle: 0.8, ringAngleInDegrees: 357, doBlackHoles: true, showRing: true, simulationSpeed: 0.1, ringColor: .orange)
    }
